        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGet("/Static/CSS/index.css", async context =>
                {
                    ...
                    context.Response.ContentType = "text/css"; // ✅ Обязательно
                ...
                endpoints.MapGet("/Static/JS/index.js", async context =>
                {
                    ...
                    context.Response.ContentType = "application/javascript"; // ✅ Обязательно
                    await context.Response.WriteAsync(js);
                });

                endpoints.MapGet("/Static/JS/indexForTesting.js", async context =>
                {
                    var jsPath = Path.Combine(Directory.GetCurrentDirectory(), "Static", "JS", "indexForTesting.js");
                    var js = await File.ReadAllTextAsync(jsPath);
                    context.Response.ContentType = "application/javascript"; // ✅ Обязательно
                    await context.Response.WriteAsync(js);
                });
